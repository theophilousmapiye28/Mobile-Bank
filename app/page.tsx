...
const Page = () => {
  return (
    <div className='flex flex-col min-h-screen ml-0 mt-[10vh] space-y-6 px-4 md:ml-[70vh] md:mt-[20vh]'>
      <div className='flex justify-start'>
        <a className='active:scale-[.98] hover:scale-[1.01] ease-in-out transition-all' href="">
   ...
   <linearGradient id="paint7_linear_3363_47878" x1="0.478772" y1="16.2332" x2="23.1752" y2="16.2332" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="paint9_linear_3363_47878" x1="17.4127" y1="14.6288" x2="12.9226" y2="20.3205" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="1" stop-color="#B0D1FF"/>
        ...
        <h1 className='text-4xl text-[#00214F] font-bold active:scale-[.98] hover:scale-[1.01] ease-in-out transition-all'>Horizon</h1>
      </div>
      <h3 className='text-4xl font-bold'>Log in</h3>
      <p className='font-light'>Welcome back! Please enter your details</p>
      <form className="flex flex-col w-full max-w-md">
        <div className="mb-6">
          <label htmlFor="email" className="text-[#344054] block mb-2 text-sm font-medium">
            Your email
          </label>
          <input
            name="email"
            ...
            id="email"
            required
            className="bg-white border border-gray-500 placeholder-[#9CA2A9] text-gray-900 text-sm rounded-lg block w-full p-2.5"
            placeholder="Enter your email"
          />
        </div>
        <div className="mb-6">
          <label htmlFor="password" className="text-[#344054] block text-sm mb-2 font-medium">
            Password
          </label>
          <input
            name="password"
        ...
        <button
          type="submit"
          className="bg-gradient-to-r from-[#01797A] to-blue-500 hover:bg-primary-600 text-white font-medium py-2.5 px-5 rounded-lg w-full active:scale-[.98] hover:scale-[1.01] ease-in-out transition-all"
        >
          Login
        </button>
        <div className="flex justify-center space-x-2 mt-4">
          <h4>Don’t have an account?</h4>
          <Link className="text-[#01797A] active:scale-[.98] hover:scale-[1.01] ease-in-out transition-all" href="/Signup">
            Sign up
          </Link>
        </div>
      </form>
